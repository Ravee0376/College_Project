...
<body>
  ...
  <div class="nav">
    ...
    <div class="nav-links">
      <ul>
        ...
        <li><a href="ploAnalysisST.php" target="_self">PLO Analysis</a></li>
  ...
  <div class="background">
    ...
    <div id="chart-container" style="display:flex;justify-content:center;margin-top:5px;height:600px;width:100%;" class="row3">
